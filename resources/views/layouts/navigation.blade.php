        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('companiesCreate')">
                            {{ __('messages.create-company') }}
                        </x-dropdown-link>

                        <x-dropdown-link :href="route('employeesCreate')">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="10">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link href="/lan-change?lang=en">
                                {{ __('EN') }}
                            </x-dropdown-link>

                            <x-dropdown-link href="/lan-change?lang=ro">
                                {{ __('RO') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
